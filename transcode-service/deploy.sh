...
JAR_NAME=${APP_HOME}/transcode-service/target/transcode-service-1.0.0.jar                     # jar包的名字
JAVA_OUT=${APP_HOME}/transcode-service/logs/start.log                                   #应用的启动日志

# 创建出相关目录
mkdir -p ${APP_HOME}
mkdir -p ${APP_HOME}/transcode-service/logs
usage() {
